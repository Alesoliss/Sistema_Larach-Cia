...
{
    public partial class DB_Sistema_LarachyciaContext : DbContext
    {
        public DB_Sistema_LarachyciaContext()
        {
        }

        public DB_Sistema_LarachyciaContext(DbContextOptions<DB_Sistema_LarachyciaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbCategorias>(entity =>
            {
                ...
                entity.Property(e => e.Cate_ImagenUrl).IsUnicode(false);
            ...
            modelBuilder.Entity<tbComprasEncabezado>(entity =>
            {
                ...
                entity.Property(e => e.Comen_FechaFactura).HasColumnType("date");
            ...
            modelBuilder.Entity<tbEmpleados>(entity =>
            {
                ...
                entity.ToTable("tbEmpleados", "Cmrl");
            ...
            {
                entity.HasKey(e => e.MtPag_Id)
                    .HasName("PK__tbMetodo__008CEF1660A3C4EF");

                entity.ToTable("tbMetodospago", "Gral");

                entity.Property(e => e.MtPag_Descripcion)
                    .HasMaxLength(50)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<tbProductos>(entity =>
            {
                ...
                entity.ToTable("tbProductos", "Cmrl");
                ...
                entity.Property(e => e.Produ_ImagenUrl).IsUnicode(false);
            ...
            modelBuilder.Entity<tbProveedores>(entity =>
            {
                ...
                entity.ToTable("tbProveedores", "Cmrl");
            ...
            modelBuilder.Entity<tbSucursales>(entity =>
            {
                ...
                entity.ToTable("tbSucursales", "Cmrl");
            ...
            modelBuilder.Entity<tbVentasEncabezado>(entity =>
            {
                ...
                entity.Property(e => e.Venen_NroTarjeta)
                    .HasMaxLength(50)
                    .IsUnicode(false);
